    ...
    if (typeof req.query.sair != "undefined" && req.query.sair == "sim") {
      ...
      res.redirect('/')
        ...
        if (typeof req.session.autenticado == 'undefined'){
          ...
          res.render('sala', {sala : req.params.sala, sessao : req.session.verificarSessao, nick : req.session.nick , steamid : req.session.steamid, btrid : req.session.btrid, img : req.session.img});
        }
    }
  }else {
    res.redirect('/');
    ...
    if (typeof req.query.sair != "undefined" && req.query.sair == "sim") {
      ...
      res.redirect('/')
        ...
        if (typeof req.session.autenticado == 'undefined'){
          ...
          res.render('checksala', {sala : req.params.sala, sessao : req.session.verificarSessao, nick : req.session.nick , steamid : req.session.steamid, btrid : req.session.btrid, img : req.session.img});
        }
    }
  }else {
    res.redirect('/');
